            ...
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mb-8">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold text-medieval-bronze">Criar Novo Monstro</h1>
                            <p class="text-gray-600">Adicione um novo monstro ao jogo</p>
                        </div>
                    </div>
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-6" enctype="multipart/form-data">
                    ...
                    <div class="flex justify-end space-x-4">
                        ...
                        >
                            ...
                            {{ form.processing ? 'Criando...' : 'Criar Monstro' }}
                        </button>
                    </div>
                </form>
            </div>
...
.monsters-create *:not(.fas):not(.fa):not([class*="fa-"]) {
