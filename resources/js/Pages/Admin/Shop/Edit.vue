...
const form = useForm({
    item_id: props.shopItem?.item_id || '',
    equipment_id: props.shopItem?.equipment_id || '',
    gold_price: props.shopItem?.gold_price || 0,
    coin_price: props.shopItem?.coin_price || 0,
    is_available: props.shopItem?.is_available || true,
    stock_quantity: props.shopItem?.stock_quantity || null,
    daily_limit: props.shopItem?.daily_limit || null,
    min_level: props.shopItem?.min_level || 1,
    max_level: props.shopItem?.max_level || null,
    is_featured: props.shopItem?.is_featured || false,
    is_limited_time: props.shopItem?.is_limited_time || false,
    available_until: props.shopItem?.available_until ? new Date(props.shopItem.available_until).toISOString().slice(0, 16) : null,
    discount_percentage: props.shopItem?.discount_percentage || 0,
});

const submit = () => {
    form.post(route('admin.shop.update', { shopItem: props.shopItem?.uuid }));
};
                ...
                <div class="mb-8">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-gray-600">Modifique as configurações do item na loja</p>
                        </div>
                        <Link
