...
const form = useForm({
    ...
    type: props.item?.type || 'potion',
    rarity: props.item?.rarity || 'common',
    image_path: null,
    effects: props.item?.effects?.map(effect => ({
...
const submit = () => {
    if (props.item?.uuid) {
        form.post(route('admin.items.update', props.item.uuid));
    }
};
                ...
                <div class="mb-8">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-gray-600">Edite as informações do item</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div v-if="item?.image_path" class="mb-3">
                                        <p class="text-sm text-gray-600 mb-2">Imagem atual:</p>
                                        <img :src="item.image_path" :alt="item.name" class="h-16 w-16 rounded-full object-cover" />
                                    </div>
                                    <input
                                        id="image_path"
