...
const filterCategory = ref(props.filters?.filter_category || '');
const sortBy = ref(props.filters?.sort_by || 'category');
const sortOrder = ref(props.filters?.sort_order || 'asc');

const updateFilters = () => {
    const filters = {};
    if (search.value) filters.search = search.value;
    if (filterCategory.value) filters.filter_category = filterCategory.value;
...
watch([search, filterCategory, sortBy, sortOrder], updateFilters, { deep: true });
    ...
    <AdminLayout>
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mb-8">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-gray-600">Gerencie as permissões do sistema</p>
                        </div>
                        <Link
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-amber-100" @click="toggleSort('category')">
                                        <i class="fas fa-tags mr-1"></i>
                                        Categoria
                                        <i v-if="sortBy === 'category'" :class="sortOrder === 'asc' ? 'fas fa-sort-up' : 'fas fa-sort-down'" class="ml-1"></i>
                                    </th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr v-for="permission in permissions.data || []" :key="permission.id" class="hover:bg-amber-50">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                <div class="h-10 w-10 rounded-full bg-medieval-bronze flex items-center justify-center">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ permission.roles_count || 0 }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                ...
                <!-- Estado vazio -->
                <div v-if="!permissions.data || permissions.data.length === 0" class="card-medieval">
                    <div class="text-center py-12">
                        ...
                        <p class="text-gray-500 mb-4">Comece criando sua primeira permissão.</p>
                        <Link
                            :href="route('admin.permissions.create')"
                            class="btn-medieval bg-medieval-gold hover:bg-medieval-bronze text-white"
                        >
                ...
                <!-- Paginação -->
                <div v-if="permissions.links && permissions.links.length > 1" class="mt-6">
